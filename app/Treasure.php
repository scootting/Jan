...
class Treasure extends Model
{
    ...
    public static function GetOnlineSalesDays($description, $year)
    {
        ...
        if ($description == '') {
            $query = "select * from val.diario vd where vd.usr_cre in ('manhattan', 'nottingham', 'vancouver', 'petrogrado', 'nairobi') and vd.gestion = '" . $year . "' order by vd.fec_tra, vd.id_dia desc";
        } else {
