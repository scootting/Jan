            ...
            <el-table-column align="right" :min-width="350" fixed="right">
              <template slot-scope="scope">
                <el-button :disabled="dataSaleDays[scope.$index].estado == 'V'"
                  @click="initSummaryDetail(scope.$index, scope.row)" type="warning" size="small" plain>editar detalles</el-button>                
                  ...
                  plain>resumen de venta de productos</el-button>
              </template>
            </el-table-column>
          </el-table>
