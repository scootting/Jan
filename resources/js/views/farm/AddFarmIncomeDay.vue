  ...
  <div>
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <span>ingreso detallado de productos</span>
      ...
      <div>
        <el-row :gutter="20">
          <el-col :span="12">
            <div class="grid-content bg-purple">
              <p>datos generales del ingreso</p>
              ...
              <el-table :data="products" style="width: 100%" size="small">
                ...
                <el-table-column align="right">
                  <template slot-scope="scope">
                    <el-button @click="initRemoveProduct(scope.$index, scope.row)" type="primary" plain
        ...
        <el-button @click="StoreCustomerSaleDetail()" type="success" size="small" plain :disabled="isDisabled">Guardar
        </el-button>
        <el-button @click="initNewCustomerSale()" type="info" size="small" plain>Salir
        </el-button>
      </div>
