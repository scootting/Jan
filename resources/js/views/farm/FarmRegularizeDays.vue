  ...
  <div>
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <span>diario de las regularizaciones de ventas al credito</span>
        <el-button style="text-align: right; float: right" size="small" type="primary" icon="el-icon-plus"
          @click="initAddFarmSaleDay">nueva regularizacion de ventas al credito</el-button>
      </div>
      <div>
        <el-table v-loading="loading" :data="dataSaleDays" style="width: 100%" size="medium" fixed>
          ...
          <el-table-column align="right" :min-width="380" fixed="right">
            <template slot-scope="scope">
              ...
              <el-button @click="initCustomerSaleDetail(scope.$index, scope.row)" type="primary" size="small"
              :disabled="dataSaleDays[scope.$index].estado != 'V'"
                plain>detalle
                de la regularizacion</el-button>
            </template>
          </el-table-column>
        </el-table>
