      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <div class="grid-content bg-purple">
            ...
            <el-form ref="form" :model="this.dataMemorial" label-width="200px" size="mini">
              <el-form-item label="carnet de identidad">
                <el-input v-model="dataMemorial.nodip" disabled></el-input>
              </el-form-item>
              <el-form-item label="apellido paterno">
                <el-input v-model="dataMemorial.paterno" disabled></el-input>
              </el-form-item>
              <el-form-item label="apellido materno">
                <el-input v-model="dataMemorial.materno" disabled></el-input>
              </el-form-item>
              <el-form-item label="nombres">
                <el-input v-model="dataMemorial.nombres" disabled></el-input>
              </el-form-item>
              <el-form-item label="fecha de nacimiento">
                <el-input v-model="dataMemorial.nacimiento" disabled></el-input>
              </el-form-item>
              <el-form-item label="sexo">
                <el-input v-model="dataMemorial.sexo" disabled></el-input>
              </el-form-item>
            </el-form>
          </div>
        </el-col>
          ...
          <div class="grid-content bg-purple">
            ...
            <el-form ref="form" :model="this.dataMemorial" label-width="200px" size="mini">
              <el-form-item label="direccion">
                <el-input v-model="dataMemorial.direccion"></el-input>
              </el-form-item>
              <el-form-item label="telefono/celular">
                <el-input v-model="dataMemorial.telefono"></el-input>
              </el-form-item>
              <el-form-item label="correo electronico">
                <el-input v-model="dataMemorial.correo"></el-input>
              </el-form-item>
            </el-form>
          </div>
        </el-col>
